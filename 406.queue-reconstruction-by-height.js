...
var reconstructQueue = function (people) {
  ...
  let sortingIdx = 0
  while (sortingIdx !== people.length) {
    const sortingItem = people[sortingIdx]
    const kOtherInFront = sortingItem[1]
    people.splice(sortingIdx, 1)
    people.splice(kOtherInFront, 0, sortingItem)
    sortingIdx++
  }
